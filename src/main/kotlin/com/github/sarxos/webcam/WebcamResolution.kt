 ...
 */
enum class WebcamResolution(width: Int, height: Int) {
     ...
     */
    WSVGA2(1024, 600),  // XGA (Extended Graphics Array)
     ...
     */
    WUXGA(1920, 1200),  // QXGA (Quad Extended Graphics Array)
     ...
     */
    WQUXGA(3840, 2400),  // HXGA (Hyper Extended Graphics Array)
     ...
     */
    WHUXGA(7680, 4800),  // HD (High-Definition)
    ...
    private fun getCommonFactor(width: Int, height: Int): Int {
        return if (height == 0) width else getCommonFactor(height, width % height)
    }
